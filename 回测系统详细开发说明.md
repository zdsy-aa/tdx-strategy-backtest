...
graph TD
    ...
    C --> F(105_chan_5buy_test.py)
    D --> G[web/client/src/data/backtest_results.json]
    E --> H[web/client/src/data/stock_reports.json]
    F --> I[web/client/src/data/chan_backtest_results.json]
    G --> J{前端页面: 策略总览 / Reports.tsx}
    H --> K{前端页面: 报告明细 / ReportDetail.tsx}
    I --> L{前端页面: 指标详解 / Indicators.tsx}
