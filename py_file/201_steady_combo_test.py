...
def main():
    ...
    # 生成报告
    report_path = os.path.join(REPORT_DIR, 'steady_combo_all_stocks_report.md')
    with open(report_path, 'w', encoding='utf-8') as f:
        f.write("# 稳健组合全量股票回测报告\n\n")
    ...
    summary.to_csv(os.path.join(REPORT_DIR, 'steady_combo_all_stocks_summary.csv'), index=False, encoding='utf-8-sig')
