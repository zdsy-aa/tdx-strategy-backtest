...
def process_single_stock(filepath: str) -> pd.DataFrame:
    try:
        ...
        results = []
        buy_signals = {'buy1': '买点1 (吸筹)', 'buy2': '买点2 (低位金叉)'}
...
def main():
    ...
    # 生成报告
    report_path = os.path.join(REPORT_DIR, 'buy_sell_points_all_stocks_report.md')
    ...
    summary.to_csv(os.path.join(REPORT_DIR, 'buy_sell_points_all_stocks_summary.csv'), index=False, encoding='utf-8-sig')
